...
from castro.lib.tools.flvrec import main as vnc2flv_main
...
class Castro:
    ...
    def init(self):
        ...
        self.recorder = Process(target= vnc2flv_main, args=[args])
